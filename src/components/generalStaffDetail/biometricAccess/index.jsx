...
import generalStaffBiometricAccessColumns from "./columns";
import "./styles.scss";
...
const GeneralStaffBiometricAccess = () => {
  ...
  const allColumns = generalStaffBiometricAccessColumns;
  ...
  return (
    <div className="general-staff-biometric-access-section">
