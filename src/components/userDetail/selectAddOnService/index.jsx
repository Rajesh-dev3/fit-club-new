...
const SelectAddOnService = () => {
  ...
  // Check if user has membership with planType "membership"
  const hasMembershipPlan = userData?.currentMembership?.planType === 'membership';

  // Filter services based on membership planType
