...
import trainerBiometricAccessColumns from "./columns";
import "./styles.scss";
...
const TrainerBiometricAccess = () => {
  ...
  const allColumns = trainerBiometricAccessColumns;
  ...
  return (
    <div className="trainer-biometric-access-section">
      <div className="table-controls">
        ...
        <div className="biometric-access-btn-col">
          <Button
            ...
            icon={<PlusOutlined />}
            onClick={() => navigate(`/trainer-detail/${id}/add-biometric-access`)}
          >
            Biometric access
          </Button>
          <ColumnVisibility
