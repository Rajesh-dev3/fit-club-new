import { Image, Tag, Button, Dropdown, Select, Modal, Form, InputNumber, DatePicker, Input, Tooltip } from "antd";
  ...
  },
  {
    ...
    render: (text, record) => {
      const tooltipContent = (
        <div style={{ padding: '8px', minWidth: 'auto', whiteSpace: 'nowrap' }}>
          <div style={{ marginBottom: '6px' }}><strong>Status:</strong> {record.status || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>Invoice Status:</strong> {record.invoiceStatus || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>Package Price:</strong> {record.packagePrice || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>Invoice Amount:</strong> {record.invoiceAmount || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>Trainer:</strong> {record.trainer || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>Sessions:</strong> {record.sessions || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>Start Date:</strong> {record.startDate || 'N/A'}</div>
          <div style={{ marginBottom: '6px' }}><strong>End Date:</strong> {record.endDate || 'N/A'}</div>
        </div>
      );
